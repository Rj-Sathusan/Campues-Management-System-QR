...
import wget
import os
remote_url = 'https://jntxmq.dm.files.1drv.com/y4m9shWdBozCFNckxj7u0aN04kYaqpGuJ9Ek8-EZqIrprih85HlppK-tHnHZSiH2cjj6LNQkpId7PbyIAZJG1bWUGPf--aYU739dHHAOEB6cNti_rRdDfOiPTtTTO-dyNvOjo6nV7DRjt1debFgxv6xJ1MkAav1j8WJQ0mStSWXt0vbCGBjtjpvnnY1xOsqSh7tMjl_d7CRjvBZ5ev9D5SzkA'
    # Define the local filename to save data
os.system("del DataUser.txt")
    # Define the remote file to retrieve
local_file = 'DataUser.txt'
    # Make http request for remote file data
wget.download(remote_url, local_file)
f = open("DataUser.txt", "r")
ok=(f.read())
k=(ok.split(","))
print(k)
window = Tk()
